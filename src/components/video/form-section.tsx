...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
  ...
  const fullUrl = `${process.env.VRECEL_URL || "http://localhost:3000"}/videos/${videoId}`;
                      ...
                      <div className="p-0.5 border border-dashed  border-neutral-400 relative h-[84px] w-[135px] group">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="start" side="right">
                            ...
                            <DropdownMenuItem onClick={() => generateThumbnail.mutate()} className="cursor-pointer">
                              <SparkleIcon className="size-4 mr-1" />
                              AI-generate
                            </DropdownMenuItem>

                            <DropdownMenuItem onClick={() => restoreThumbnail.mutate({id: videoId})} className="cursor-pointer">
